...
const phoneSvgContainerVariant={
    animate:{
        opacity:0,
        transition:{
            delay:2,
...
function ContactSection(){
    ...
    const isInView=useInView(targetRef,{amount:0.7})
    ...
    return(
        <div className="contact-section-container" ref={targetRef}>
           ...
           <motion.div variants={phoneSvgContainerVariant} animate={isInView && "animate"} className="phone-svg-container">
          ...
          <motion.form variants={formVariant} initial="hidden" whileInView="visible" viewport={{once:true,amount:0.7}}  onSubmit={handleSubmit}>
